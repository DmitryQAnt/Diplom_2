...
public class ChangeCustomerDataWithoutAuthorizationFailTest {
    ...
    public void checkCreateNewCustomerWithUniqueData() {
        ...
        ValidatableResponse response1 = CustomerOperations.changeDataWithoutAuthorization(bearer, updatedCustomer);
        check.updatingDataIsFail(response1);
